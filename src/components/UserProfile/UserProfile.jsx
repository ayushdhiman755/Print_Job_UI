    ...
    <div>
      ...
      >
        <tbody>
          ...
          <tr>
            <td width="30%">Total Jobs </td>
            <td>{userDetails?.jobs?.length}</td>
          </tr>
          <tr>
            <td width="30%">Delivered </td>
            <td>
              <div
                style={{
                  display: "grid",
              ...
              >
                <span>{userDetails?.deliveredJobs?.length}</span>
                <LinearProgress
                  variant="determinate"
                  value={
                    userDetails?.jobs?.length > 0
                      ? (userDetails?.deliveredJobs?.length /
                          userDetails?.jobs?.length) *
                        100
                      : 100
                  }
                />
